    ...
    return (
        <div className="relative flex items-center justify-center">
            ...
            <form className="w-full md:w-1/2 px-14" onSubmit={handleSubmit}>
                <h1 className="font-semibold text-xl md:text-2xl mt-5">Register Here Collector!</h1>
                ...
                <div className="flex flex-col gap-2 mt-5">
                    ...
                    <div className="flex justify-center gap-2">
                        <button className="self-center font-semibold bg-green-600 text-white w-1/2 text-center rounded-full mt-3">Submit</button>
                    </div>
                </div> 
            </form>
