const CustomerJunkShops = () => {
    return (
        <div className="h-screen w-full">
            ...
            <iframe src="https://my.atlist.com/map/7c3d70a1-b36e-452d-a4a0-496b48efa66f?share=true" allow="geolocation 'self' https://my.atlist.com" width="100%" height="85%" frameborder="0" scrolling="no" allowfullscreen></iframe>
        </div>
    )
}
