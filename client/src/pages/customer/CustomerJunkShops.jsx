const CustomerJunkShops = () => {
    return (
        <div className="h-screen w-full">
            ...
            <iframe src="https://my.atlist.com/map/df84daa7-5443-4bcc-acad-f508a2392f85?share=true" allow="geolocation 'self' https://my.atlist.com" width="100%" height="700px" loading="lazy" frameborder="0" scrolling="no" allowfullscreen></iframe>
        </div>
    )
}
