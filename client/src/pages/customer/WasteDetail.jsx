...
const WasteDetail = () => {
    ...
    return (
        <div className="w-full h-auto bg-green-50 flex flex-col items-center pb-36">
            ...
            <div className="md:w-1/2 w-full flex flex-col items-center">
                <div className="bg-white border border-gray-800 shadow-2xl rounded-lg h-56 w-11/12 mt-5 flex items-center justify-center">
