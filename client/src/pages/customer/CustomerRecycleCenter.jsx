...
const CustomerRecycleCenter = () => {
    ...
    return (
        <div className="h-screen w-full">
            ...
            <iframe src="https://my.atlist.com/map/8258b006-5495-4b0f-8188-9b1b1ec7b2e1?share=true" allow="geolocation 'self' https://my.atlist.com" width="100%" height="700px" loading="lazy" frameborder="0" scrolling="no" allowfullscreen></iframe>
       </div>
    )
}
