           ...
           <div className="bg-green-200 p-5">
            ...
            <div className="absolute flex items-center  justify-center h-screen top-0">
                ...
                <div className="relative">
                    ...
                    <img onClick={() => openRecycleCenter('Wawa II')} className="absolute left-9 object-contain bottom-36" src="/images/recycle-icon.png" alt="marker" />
                    <img onClick={() => openRecycleCenter('Wawa III')} className="absolute left-12 object-contain bottom-16" src="/images/recycle-icon.png" alt="marker" />
                    <img onClick={() => openRecycleCenter('Sapa I')} className="absolute left-24 object-contain top-24" src="/images/recycle-icon.png" alt="marker" />
                    <img onClick={() => openRecycleCenter('Sapa II')} className="absolute top-20 left-14 object-contain bottom-0" src="/images/recycle-icon.png" alt="marker" />
                    <img onClick={() => openRecycleCenter('Sapa III')} className="absolute top-24 left-12 object-contain bottom-0" src="/images/recycle-icon.png" alt="marker" />
                    <img onClick={() => openRecycleCenter('Kanluran')} className="absolute left-20 object-contain top-12" src="/images/recycle-icon.png" alt="marker" />
                </div>
            </div>
