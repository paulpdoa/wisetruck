...
const CustomerRecycleCenter = () => {
    ...
    return (
        <div className="h-screen w-full">
            ...
            <iframe src="https://my.atlist.com/map/bbed1384-668a-4816-a478-1412c60731fd?share=true" allow="geolocation 'self' https://my.atlist.com" width="100%" height="700px" loading="lazy" frameborder="0" scrolling="no" allowfullscreen></iframe>
       </div>
    )
}
