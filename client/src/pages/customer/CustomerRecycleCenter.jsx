    ...
    return (
        <div className="h-screen w-full">
           <div className="bg-green-200 p-5">
            ...
            <iframe src="https://my.atlist.com/map/bf6b6cf7-bdad-4f7d-9117-1759b5b2c7c8?share=true" allow="geolocation 'self' https://my.atlist.com" width="100%" height="85%" frameborder="0" scrolling="no" allowfullscreen></iframe>
       </div>
    )
}
