...
const CustomerRecycleCenter = () => {
    ...
    return (
        <div className="h-screen w-full">
            ...
            <iframe src="https://my.atlist.com/map/0d4b4b5a-f9d5-4b2e-9586-0a041067a127?share=true" allow="geolocation 'self' https://my.atlist.com" width="100%" height="700px" frameborder="0" scrolling="no" allowfullscreen></iframe>
       </div>
    )
}
