    ...
    return (
        <div className="w-full h-auto flex flex-col items-center">
            <div className="bg-green-200 p-5 w-full">
                <h1 className="font-semibold text-gray-500 text-center text-lg">ELECTRONIC WASTES</h1>
            </div>
            ...
            <div className="grid grid-cols-2 justify-items-center py-20 gap-8 w-11/12">
                ...
                { records?.filter(record => record.typeOfWaste === 'Electronic Waste').map((record,idx) => (
