...
const ElectronicWaste = () => {
    ...
    const wastes = records?.filter(record => record.typeOfWaste === 'Electronic Waste');
    ...
    return (
        <div className="w-full h-auto flex flex-col items-center">
            <div className="bg-green-500 p-5 relative w-full">
                ...
                <h1 className="font-semibold text-gray-900 text-center text-lg">ELECTRONIC WASTES</h1>
            </div>
